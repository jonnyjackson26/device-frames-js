...
const iphoneDevices = await listDevices("apple-iphone");
console.log(`iPhone devices: ${iphoneDevices.length}`);

const iphone16ProMax = await listDevices("apple-iphone", "16-pro-max");
...
const template = await findTemplate("16-pro-max", "black-titanium", { category: "apple-iphone" });
console.log(template);

// Test getFrameImage
console.log("\n=== Testing getFrameImage ===");
const frame = await getFrameImage("16-pro-max", "black-titanium", { category: "apple-iphone" });
...
const mask = await getMaskImage("16-pro-max", "black-titanium", { category: "apple-iphone" });
